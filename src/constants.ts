...
export const AREUM_ACCENT_COLOR = "accent-clay"; // Tailwind custom color name for the primary accent
...
// export const PATTERN_DETAIL_TOOLBAR_HEIGHT = '60px'; // Approximate height of the toolbar - Now dynamically calculated
