...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-bg-secondary dark:bg-bg-secondary p-6 md:p-8 rounded-lg shadow-xl">
        ...
        {isSubmitted ? (
          <div className="p-6 text-center bg-accent-emerald/10 dark:bg-accent-emerald/20 border border-accent-emerald/30 dark:border-accent-emerald/40 rounded-md">
            ...
            <p className="text-accent-emerald/80 mt-1">Your message has been sent. I'll get back to you as soon as possible.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className={`mt-1 block w-full px-3 py-2 border border-border-medium dark:border-border-medium rounded-md shadow-sm focus:outline-none focus:ring-${AREUM_ACCENT_COLOR} dark:focus:ring-${AREUM_ACCENT_COLOR} focus:border-${AREUM_ACCENT_COLOR} dark:focus:border-${AREUM_ACCENT_COLOR} sm:text-sm bg-bg-primary dark:bg-bg-primary text-text-primary`}
              />
            </div>
            <div>
         ...
         <div className="mt-8 pt-6 border-t border-border-light dark:border-border-light text-center">
            ...
            <div className="flex justify-center space-x-4">
                <a href="#" className={`text-text-muted hover:text-${AREUM_ACCENT_COLOR} dark:hover:text-${AREUM_ACCENT_COLOR} transition-colors`} aria-label="Instagram">
                 ...
                 <a href="#" className={`text-text-muted hover:text-${AREUM_ACCENT_COLOR} dark:hover:text-${AREUM_ACCENT_COLOR} transition-colors`} aria-label="Ravelry">
                    <svg className="h-7 w-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
                </a>
            </div>
        </div>
      </div>
