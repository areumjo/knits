    ...
    <footer className="bg-bg-secondary border-t border-border-light text-sm text-text-muted">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" aria-label="Instagram" className={`text-text-muted hover:text-${AREUM_ACCENT_COLOR} dark:hover:text-${AREUM_ACCENT_COLOR} transition-colors`}><HeartIcon className="h-5 w-5" /></a>
              <a href="#" aria-label="Pinterest" className={`text-text-muted hover:text-${AREUM_ACCENT_COLOR} dark:hover:text-${AREUM_ACCENT_COLOR} transition-colors`}><HeartIcon className="h-5 w-5" /></a>
              <a href="#" aria-label="Ravelry" className={`text-text-muted hover:text-${AREUM_ACCENT_COLOR} dark:hover:text-${AREUM_ACCENT_COLOR} transition-colors`}><HeartIcon className="h-5 w-5" /></a>
            </div>
        ...
        <div className="border-t border-border-light pt-6 text-center text-xs">
          <p className="font-primary text-base text-text-secondary mb-3">Making things that last, with intention.</p>
