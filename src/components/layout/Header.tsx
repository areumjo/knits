...
export const Header: React.FC = () => {
  ...
  // AREUM_ACCENT_COLOR is 'accent-clay', which is defined in Tailwind config
  ...
  return (
    <header className="sticky top-0 z-50 bg-bg-secondary/80 dark:bg-bg-secondary/80 backdrop-blur-md shadow-sm">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to="/" className={`font-primary text-2xl font-bold text-text-primary hover:text-accent-clay dark:hover:text-accent-clay transition-colors`}>
          {SITE_NAME}
        </Link>
